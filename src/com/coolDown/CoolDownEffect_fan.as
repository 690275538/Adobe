package com.coolDown{
	 ...
	 * @author Adobe
	 *实例
	 * 	fanEft = new CoolDownEffect_fan();
	 *	fanEft.play(sp, shijian*1000, -90, playComplete, new TextFormat(null, 18, 0x00ffff, true));
	...
	public class CoolDownEffect_fan
	{
		...
		private function enterFrameHandler(event:Event):void
		{
			...
			if (_coolTimeTextFormat)
			{
				...
				var remainingTime:Number = (_duration - interval) / 1000;
